...
gl_pre_flops = 14.0 * M * K
gl_post_flops = 14.0 * M * N

workload_per_iter = gemm_flops + gl_pre_flops + gl_post_flops
workload_only_gemm_per_iter = gemm_flops

print(f"\nBenchmarking {measure_iters} iterations of GEMM + Gelu [{dtype}]...")
t = benchmark.Timer(
    stmt="composite_op()",
