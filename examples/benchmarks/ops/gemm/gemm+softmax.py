...
sm_pre_flops = 5.0 * M * K
sm_post_flops = 5.0 * M * N

workload_per_iter = gemm_flops # + sm_pre_flops + sm_post_flops

print(f"\nBenchmarking {measure_iters} iterations of GEMM + Softmax [{dtype}]...")
t = benchmark.Timer(
    stmt="composite_op()",
